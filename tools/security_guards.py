...
ALLOWED_PERMISSIONS = {
    ...
    # AU fork: SEEK is Python stdlib (tools/seek-search/seek_search.py).
    # Optional LinkedIn CLI (bun) when tools/linkedin-search is installed.
    "Bash(python tools/seek-search/seek_search.py:*)",
    "Bash(python3 tools/seek-search/seek_search.py:*)",
    "Bash(python tools/parse_posting.py:*)",
    "Bash(python3 tools/parse_posting.py:*)",
    "Bash(python tools/application_paths.py:*)",
    "Bash(python3 tools/application_paths.py:*)",
    "Bash(python tools/latex_build.py:*)",
    "Bash(python3 tools/latex_build.py:*)",
    "Bash(python tools/html_build.py:*)",
    "Bash(python3 tools/html_build.py:*)",
    "Bash(python tools/cleanup_latex.py:*)",
    "Bash(python3 tools/cleanup_latex.py:*)",
    "Bash(python tracker/upsert_application.py:*)",
    "Bash(python3 tracker/upsert_application.py:*)",
    "Bash(bun run tools/linkedin-search/cli/src/cli.ts:*)",
...
REQUIRED_IGNORE_RULES = [
    ...
    # to its own directory, so the state file lands under skills/... and
    ...
    # skills/upskill/upskill/*.md where the rooted rule cannot see
